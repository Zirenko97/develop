...
app.run();
const player1 = app.firstPlayer;
const player2 = app.secondPlayer;
const ship1 = player1.board.ships[0];
const ship2 = player2.board.ships[0];

console.log(`"${player1.name} ${player1.board.ships.length} ${ship1.length} ${ship1.startX},${ship1.startY} ${ship1.orientation}"`);
console.log(`"${player2.name} ${player2.board.ships.length} ${ship2.length} ${ship2.startX},${ship2.startY} ${ship2.orientation}"`);
console.log(`"${app.winner.name}"`);
